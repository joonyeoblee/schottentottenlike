...
namespace MoreMountains.Tools
{
    public class MMReorderableList
    {
        ...
        public SerializedProperty List { get; set; }
        ...
        */
        ...
        private int GetDragIndexFromSelection(int index)
        {
            ...
            return Array.FindIndex(dragList, t => t.startIndex == index);
        }
        ...
        private static class Style
        {
            ...
            public static readonly GUIContent iconToolbarPlusMore;
            ...
            public static readonly GUIStyle elementBackground;
